...
- Tại ô (1, 1) Agent cảm nhận được không có _Breeze_ và không có _Stench_
    ...
    Áp dụng luật __Modus Ponens__ giữa $R_9$ và $R_1$:
    ...
    Áp dụng luật __Modus Ponens__ giữa $R_{14}$ và $R_2$:
...
- Tại ô (2, 1) Agent cảm nhận được có _Breeze_ và không có _Stench_.
    ...
    Áp dụng luật __Resolution__ giữa $R_{23}$ và $R_{5}$:
...
- Tại ô (1, 2), Agent cảm nhận được có _Stench_ và không có _Breeze_.
    ...
    Áp dụng luật __Resolution__ giữa $R_{43}$ và $R_6$:
...
Sau đó Agent quay trở lại ô xuất phát $(1,1)$ qua con đường cũ:
